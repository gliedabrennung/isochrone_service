...
Требования на сервис — в `TZ-isochrone-service.md`, ссылки на пункты ТЗ приводятся по
тексту. Машиночитаемая спецификация API — `docs/openapi.yaml` и живой Swagger UI.
