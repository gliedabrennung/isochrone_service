...
| Профиль | Скачивание | Вырезка bbox + вода | Сборка тайлов | Итого |
|---|---|---|---|---|
| `almaty` | *(измерить и внести)* | *(измерить и внести)* | *(измерить и внести)* | *(измерить и внести)* |
| `almaty-region` | *(измерить и внести)* | *(измерить и внести)* | *(измерить и внести)* | *(измерить и внести)* |
| `kazakhstan` | *(измерить и внести)* | *(измерить и внести)* | *(измерить и внести)* | *(измерить и внести)* |

> Таблица заполняется фактическими замерами на эталонной конфигурации перед сдачей
> (требование п. 8.2 и 11.4 ТЗ). Скачивание исходного PBF Казахстана — около 700 МБ –
> 1.2 ГБ независимо от профиля, потому что вырезка bbox делается локально из общей выгрузки.
> Чтобы не качать страну целиком, укажите `OSM_EXTRACT_URL` на готовый мелкий экстракт.
